...
<img src="https://github.com/alikhutaba/Android-shape-image-button/blob/master/app/src/main/res/drawable/Screenshot_1.png?raw=true">
...
```
	dependencies {
	        implementation 'com.github.alikhutaba:Android-shape-image-button:Tag'
	}
```
## Usage
